...
function ConnectOasisBotRunCard() {
  ...
  const runOasisBot = () => {
    if (exchange === "bithumb" ? Number(startBalance) < 5000 : Number(startBalance) < 100) {
      openDialog(
        <InfoDialog
          title="거래금액"
          description={[
            `거래금액은 ${exchange === "bithumb" ? "₩5,000" : "$100"} 부터 가능합니다.`,
          ]}
...
export default ConnectOasisBotRunCard;
